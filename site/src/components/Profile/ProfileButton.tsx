...
export default function ProfileButton() {
	...
	return (
		<div className="flex items-center md:order-2">
    	    ...
    	    {
    	    isOpen&&  <div className="hidden absolute top-2 right-2 z-40 w-40 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
