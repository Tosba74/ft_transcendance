...
export default function BurgerButton({ logged }: BurgerButtonProps) {
    ...
    return (
        <div>
            ...
            <div className={classNames("absolute w-full shadow-lg md:relative right-0 items-center sm:justify-center md:justify-between justify-end md:flex md:w-auto md:order-1 md:visible", isOpen ? "visible" : "invisible")}>
                <ul className="flex flex-col p-4 mt-4 md:rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-cyan-500 md:visible">
                    <Link to="/game" className="block py-2 pl-3 pr-4 text-white bg-cyan-500 rounded md:bg-transparent md:text-cyan-500 md:p-0 dark:text-white" aria-current="page">
                        Game
                    </Link>
                    <Link to="/setprofil" className="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                        Profil
                    </Link>
