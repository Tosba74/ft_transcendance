...
export default function BurgerButton({ logged }: BurgerButtonProps) {
    ...
    return (
        <div>
            ...
            <div className={classNames("absolute shadow-lg md:relative right-2 items-center sm:justify-between md:justify-between justify-end md:flex md:w-auto md:order-1 md:visible", isOpen ? "visible" : "invisible")}>
