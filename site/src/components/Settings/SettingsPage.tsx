  ...
  return (
    <div>
      <div className="h-screen w-full md:flex md:justify-center">
        <div className="mt-2 flex h-5/6 w-full flex-col gap-2 rounded border border-gray-300 bg-gray-200 p-2 shadow-xl dark:bg-gray-700 md:w-5/6 lg:w-full lg:flex-row">
