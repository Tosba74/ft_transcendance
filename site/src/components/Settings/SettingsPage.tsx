...
export default function SettingsPage({ loginer }: SettingsPageProps) {
  ...
  return (
    <div>
      ...
      <br />
      <Pseudo loginer={loginer} setPageErrorMessage={setPageErrorMessage} />
      <br />
      <Avatar loginer={loginer} setPageErrorMessage={setPageErrorMessage} />
      <br />
      <TfaButton loginer={loginer} setPageErrorMessage={setPageErrorMessage} />
      <br />
