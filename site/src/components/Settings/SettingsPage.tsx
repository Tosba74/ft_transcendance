...
export default function SettingsPage({ loginer }: SettingsPageProps) {
  ...
  return (
    <div className="h-full w-full p-2 md:flex md:justify-center">
      <div className="flex h-4/6 min-h-[550px] w-full flex-col gap-2 rounded border border-gray-300 bg-gray-200 p-2 shadow-xl dark:border-gray-700 dark:bg-gray-700 md:w-5/6 lg:w-full lg:flex-row">
