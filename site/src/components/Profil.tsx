	...
	return (
		// <div className="w-full h-screen">
			...
			<div className="flex justify-center">
				...
				<div className="w-full mt-5 p-10 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
					<div className="flex flex-col items-center pb-10 h-80">
						...
						<span className="text-sm mt-3 text-gray-500 dark:text-gray-400">{profile.title}</span>
