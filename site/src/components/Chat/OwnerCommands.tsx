        ...
        createPortal(
          <div
            ...
            className={classNames(
              "absolute left-1/2 top-1/2 z-50 min-w-[250px] -translate-x-1/2 -translate-y-1/2 items-center rounded-lg bg-gray-100 p-6 shadow-lg dark:bg-gray-800 dark:text-white",
