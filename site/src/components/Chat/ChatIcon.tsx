	...
	return (
		...
		<div className="bottom-5 right-0 items-center items-justify-center p-2 h-max">
			...
			<div className='flex justify-center justify-content-center mt-2 rounded-full shadow-lg'>
				<button type="button" onClick={handleClick} className={classNames("flex h-12 rounded-full items-center transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none", isOpen ? "w-96 justify-between" : "w-12 justify-end")}>
					...
					<div className={classNames("flex", isOpen ? "mr-4" : "mr-4")}>
