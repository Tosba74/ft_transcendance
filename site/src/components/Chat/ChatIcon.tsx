...
export default function ChatIcon() {
	...
	return (
		<div className={classNames("lg:flex lg:flex-col pt-16 pb-20 md:pt-20 w-screen", isOpen ? "h-screen" : "h-full")}>
			{isOpen && <div className="lg:flex lg:flex-row-reverse w-screen lg:pr-2 h-full">
				<ChatPage />
			</div>
			}
			<div className='flex justify-end justify-content-end right-2 pr-2 mt-2 rounded-full'>
				{!isOpen &&
					<div>
						<button type="button" onClick={handleClick} className="flex h-12 shadow-lg rounded-full items-center transition duration-500 ease-in-out text-white bg-cyan-500 hover:bg-blue-400 focus:outline-none w-12 justify-end">
							<div className="flex">
								<div className="mr-4">
				...
				{isOpen &&
					<div className=''>
						<button type="button" onClick={handleChange} className="flex h-12 rounded-full shadow-lg items-center transition duration-500 ease-in-out text-white bg-cyan-500 hover:bg-blue-400 focus:outline-none justify-between">
