      ...
      {chats.chatOpen && (
        <div
          ...
          className={classNames(
            ...
            "absolute top-20 bottom-10 z-50 flex w-full min-w-full max-w-[98%] flex-col rounded-lg bg-gray-300 p-2 shadow-lg dark:bg-gray-800 sm:min-w-[325px] md:top-20 md:right-2 md:w-1/2 lg:top-20 lg:w-1/3"
          )}
          onAnimationEnd={() => {
            if (!animation) {
              chats.setChatOpen("");
